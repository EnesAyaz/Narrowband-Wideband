...
float operation_frequeuency=40000;
...

{
    ...
    while (1)
    {
    	...
    	if (VFMODE==0)
                 ...
                 if (fModulationIndexDefault<ma_max && fundamental_freq< f_max && fModulationIndexDefault>=0.05 )
    	       	    	{
    	       	    			fModulationIndexDefault=fModulationIndexDefault+0.001;
    	       	    		    fundamental_freq=fundamental_freq+0.015;
    	       	    		    DELAY_US(100000);
    	       	    	}

             	 if (fModulationIndexDefault<0.05 )
                	    	       	    	{
                	    	       	    			fModulationIndexDefault=fModulationIndexDefault+0.001;
                	    	       	    		    DELAY_US(100000);
                	    	       	    	}
    ...
    /*	if (VF_constant-VF_constant_early>50)
        	{VF_constant =VF_constant_early;}
        else if (VF_constant-VF_constant_early<-50)
        	{VF_constant=VF_constant_early;}

    	if (VF_constant>1000)
    		{VF_constant =1000;}
    	else if (VF_constant<0)
    		{VF_constant=0;}

    	VF_constant_early=VF_constant;

    	fundamental_freq=VF_constant/50;

    	if (fundamental_freq<2)
    	    	   {fModulationIndexDefault=0.05+fundamental_freq/40;}
    	    	else
    	    	{fModulationIndexDefault=fundamental_freq/20;}

    	 */

   /* 	fModulationIndexDefault= VF_constant/100;

    	fundamental_freq2=(22*fModulationIndexDefault-2);

    	if (fundamental_freq2<0)
    	   {fundamental_freq=0;}
    	else
    	{fundamental_freq=fundamental_freq2;}
    	*/

    	/* if (fModulationIndexDefault<0.2)
    	{fundamental_freq=8*fModulationIndexDefault;}
    	else if (fModulationIndexDefault<0.4)
    	    	{fundamental_freq=10*fModulationIndexDefault;}
    	else if (fModulationIndexDefault<0.6)
    	    	    	{fundamental_freq=12*fModulationIndexDefault;}
    	else if (fModulationIndexDefault<0.8)
    	    	    	    	{fundamental_freq=16*fModulationIndexDefault;}
    	else {fundamental_freq=20*fModulationIndexDefault;}
    	*/

	/*if (fModulationIndexDefault<0.05)
        	{phase =41;}
    	else if (fModulationIndexDefault<0.15)
        	{phase=41.2;}
    	else if (fModulationIndexDefault<0.25)
    	        	{phase=41.8;}
    	else if (fModulationIndexDefault<0.35)
    	        	{phase=42.7;}
    	else if (fModulationIndexDefault<0.45)
    	        	{phase=44;}
    	else if (fModulationIndexDefault<0.55)
    	        	{phase=45.7;}
    	else if (fModulationIndexDefault<0.65)
    	        	{phase=47.5;}
    	else if (fModulationIndexDefault<0.75)
    	        	{phase=49;}
    	else if (fModulationIndexDefault<0.85)
    	        	{phase=50;}
    	else if (fModulationIndexDefault<0.95)
    	    	        	{phase=49;}
