% load('wideband.mat')
load('narrowband_inverter_far.mat')
% load('narrowband_inverter_close.mat')
%%
...
% recordLength2=N;
 ...
 i=185;
recordLength2=recordLength-i+1;
data2=data(i:end);
...
% Create textarrow
annotation(figure1,'textarrow',[0.637142857142857 0.6],[0.54 0.4225],...
    'String',{'0.28 (expected 0.30)'},...
    'FontSize',20,...
    'FontName','Times New Roman');

% Create textarrow
annotation(figure1,'textarrow',[0.422857142857143 0.494285714285714],...
    [0.665 0.43],'String',{'0.30 (expected 0.32)'},'FontSize',20,...
    'FontName','Times New Roman');
