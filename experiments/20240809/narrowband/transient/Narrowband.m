load('narrowband_transient_ch1.mat')
CH1data=data; 
CH1_time=time; 

 load('narrowband_transient_ch2.mat')
CH2data=data; 
CH2_time=time; 

load('narrowband_transient_ch3.mat')
CH3data=data; 
CH3_time=time; 

load('narrowband_transient_ch4.mat')
CH4data=data; 
CH4_time=time; 

load('narrowband_transient_ch5.mat')
CH5data=data; 
CH5_time=time; 
...
hold on; 
% plot(CH2_time(N1:N)*1e3, CH2data(N1:N)*10)
% % hold on; 
...
plot2 = plot(CH2_time*1e3, CH2data*10+65,'Parent',axes1);
plot1 = plot(CH3_time*1e3, CH3data*10+40,'Parent',axes1);
...
set(axes1,'FontName','Times New Roman','FontSize',15,'GridAlpha',0.75,...
    ...
    'XGrid','on','XMinorGrid','on','XTick',[-26:2:14],...
    'XTickLabel',{},...
    'YGrid','on','YMinorGrid','on','YTick',[-22:5:82],'YTickLabel', {});
