...
#define SWITCHINGFREQUENCY    2400         // Hz


float operation_frequeuency = 486000;

#define LOOPFREQUENCY    486000         // Hz
...
__interrupt void cpu_timer0_isr(void)
{
    ...
    if (operation_frequeuency>1000 && operation_frequeuency<520000)
...
//	}
    ...
    iSinusoidalPWMCounter = iSinusoidalPWMCounter + 1;
    if (iSinusoidalPWMCounter > ((LOOPFREQUENCY / fundamental_freq) ))
    iSinusoidalPWMCounter = 0;
